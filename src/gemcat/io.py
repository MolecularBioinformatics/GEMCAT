...
def load_json_cobra(json_file: Union[str, Path]) -> tuple[Model, cobra.Model]:
    """
    ...
    return convert_cobra_model(cobra_model), cobra_model


def load_sbml_cobra(sbml_file: Union[str, Path]) -> tuple[Model, cobra.Model]:
    """
